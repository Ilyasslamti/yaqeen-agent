...
.block-container{ padding-top: 1.25rem; direction: rtl; }

/* Keep Streamlit header visible (hamburger lives there) */
...
/* Ensure sidebar toggle control always visible */
button[kind="header"]{ color: var(--text) !important; }
...
h1{ font-weight: 800; }
h2{ font-weight: 800; }
p, label, .stMarkdown, .stText{ color: var(--text); }
