...
# 0. إعدادات النظام
# ==========================================
SYSTEM_VERSION = "V6.0_FIXED_ICONS"
...
# ==========================================
# 3. CSS (تم إصلاح مشكلة الأيقونات المشوهة)
# ==========================================
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;800&display=swap');
    
    /* 1. تطبيق الخط العربي على النصوص فقط (تجنب النجمة *) */
    html, body, h1, h2, h3, h4, h5, h6, p, div, span, label, button, input, textarea, .stMarkdown, .stText {
        font-family: 'Cairo', sans-serif;
        text-align: right;
    }
    
    /* 2. حماية الأيقونات من التشوه (الحل للمشكلة في الصورة) */
    i, .material-icons, [data-testid="stExpander"] svg, .st-emotion-cache-1pbqpg9 {
        font-family: initial !important; /* العودة للخط الأصلي للأيقونات */
    }
...
# دالة الجلب مع كسر الحماية (User-Agent)
