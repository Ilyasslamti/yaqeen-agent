...
st.title("🛡️ منادجر تك | الرادار الصحفي الشامل")
st.caption("الإصدار V2.7 - إدارة منادجر تك بـ 200 مصدر و26 محركاً دواراً")
...
for i, cat in enumerate(list(RSS_DATABASE.keys())):
    with tabs[i]:
        ...
        if cat in db["data"] and db["data"][cat]:
            ...
            if st.button("🚀 هندسة وصياغة بأسلوب صحفي ", key=f"run_{i}"):
