...
def check_password():
    ...
    if not st.session_state["authenticated"]:
        st.markdown("<div style='text-align: center; background: #1e3a8a; color: white; padding: 2rem; border-radius: 15px;'><h1>🔐 وكيل يقين الصحفي</h1><p>إدارة الماندجر - نظام الصياغة الاحترافي</p></div>", unsafe_allow_html=True)
