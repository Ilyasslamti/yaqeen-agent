...
لا جمل معلّقة أو تابعة بلا فاعل واضح.

أي إخلال = فشل كامل في التنفيذ.

2. المبني للمعلوم إلزامي 100%

كل جملة يجب أن تحتوي على فاعل صريح ومحدد.

يُمنع المبني للمجهول بصوره كافة.
...
✔️ شددت الجهات المختصة…

3. الكلمات المحظورة (ZERO TOLERANCE)

يُمنع استخدام الكلمات التالية أو أي مرادف إنشائي لها:
...
3 إلى 4 جمل كحد أقصى.
تُجيب بوضوح: من؟ متى؟ أين؟ لماذا يهم الخبر؟
...
جملتان إلى ثلاث.
قراءة مستقبلية أو تثبيت دلالة الخبر.
دون إعادة تلخيص..
