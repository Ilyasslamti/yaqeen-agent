...
قاعدة صارمة: كل فقرة بعد الأولى يجب أن تبدأ بكلمة أو تركيب انتقالي.
...
🔹 العنوان (H1): خبري، واضح، غير إنشائي، لا مبالغة، يعكس جوهر الحدث، لا يكون العنوان أكثر من سطر ونصف في أقصى الحالات.
🔹 المقدمة (فقرة واحدة): جملتان إلى ثلاث، سرد متصل، لا تقطيع.
🔹 المتن: فقرات قصيرة، كل فقرة تطور التي قبلها، استعمال انتقالي إجباري في البداية.
🔹 الخاتمة: ليست دعاء، ليست رأيًا شخصيًا، قراءة واقعية أو مطلب مهني أو أفق أمني.
...
انقص من المبني للمجهول قدر المستطاع وإلى أقصى درجة.
لا تُكرر الفاعل اسميًا.
نوّع بالإحالة: (المشتبه فيه، المعني بالأمر، المعنيون، المصالح الأمنية).
...
لا شرح، لا ملاحظات، لا مقدمات خارجية.
الخلاصة: أنت تكتب المقال بطريقة صحفي مخضرم. لا أريد كلمات فقط أو نصوص جافة، أريد النص ينبض بالحياة ويكون بكلمات انتقالية وكفقرات منسقة وجميلة. 
